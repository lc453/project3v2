  ...
  export default {
    ...
    methods: {
      ...
      async getAdventurers() {
        try {
          this.adventurers = this.$root.$data.adventurers;
          return true;
        } catch (error) {
          console.log(error);
        }
      ...
      async deleteAdventurer(adventurer) {
        try {
          //let index = this.adventurers.findIndex(guy => guy.id===adventurer.id)
          let index = this.$root.$data.adventurers.findIndex(guy => guy.id === adventurer.id);
          this.$root.$data.adventurers.splice(index);
      ...
      async editAdventurer(adventurer) {
        try {
          let index = this.$root.$data.adventurers.findIndex(guy => guy.id === adventurer.id);
          this.$root.$data.adventurers[index]={
            id: this.findAdventurer.id,
